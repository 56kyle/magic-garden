...
**[📚 View Documentation](https://magic-garden.readthedocs.io/)** | **[🐛 Report a Bug](https://github.com/56kyle/magic-garden/issues)** | **[✨ Request a Feature](https://github.com/56kyle/magic-garden/issues)**

---

## Installation

You can install `magic_garden` via [pip](pip-documentation) from PyPI:

```bash
pip install magic_garden
```

### Installation for Development

To set up `magic_garden` for local development:

1.  Clone the repository:
    ```bash
    git clone https://github.com/56kyle/magic-garden.git
    cd magic-garden
    ```
...
# from magic_garden import some_function
...
# magic-garden --help
# magic-garden do-something --input file.txt
```
...
Report bugs or suggest features via the [issue tracker](https://github.com/56kyle/magic-garden/issues).
...
[documentation]: https://magic-garden.readthedocs.io/
